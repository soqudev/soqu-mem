# Contributing to soqu-mem

Thanks for contributing. soqu-mem enforces a strict **issue-first workflow** — every change starts with an approved issue.
...
soqu-mem uses a lightweight, regular cadence so contributors know what to expect.
...
- Issues that are vague, a duplicate, or belong in [Discussions](https://github.com/soqudev/soqu-mem/discussions)
