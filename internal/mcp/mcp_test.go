...
func TestHandleCapturePassiveDefaultsSourceAndSession(t *testing.T) {
	...
	obs, err := s.RecentObservations("soqu-mem", "project", 5)
	if err != nil {
...
func TestHandleSearchAndCRUDHandlers(t *testing.T) {
	s := newMCPTestStore(t)
	if err := s.CreateSession("s-mcp", "soqu-mem", "/tmp/soqu-mem"); err != nil {
...
func TestHandlePromptContextStatsTimelineAndSessionHandlers(t *testing.T) {
	s := newMCPTestStore(t)
	if err := s.CreateSession("s-flow", "soqu-mem", "/tmp/soqu-mem"); err != nil {
		t.Fatalf("create session: %v", err)
	}
	...
	recent, err := s.RecentObservations("soqu-mem", "project", 1)
...
func TestMCPHandlersReturnErrorsWhenStoreClosed(t *testing.T) {
	s := newMCPTestStore(t)
	if err := s.CreateSession("s-closed", "soqu-mem", "/tmp/soqu-mem"); err != nil {
		t.Fatalf("create session: %v", err)
	}
	...
	promptRes, err := handleSavePrompt(s)(context.Background(), mcppkg.CallToolRequest{Params: mcppkg.CallToolParams{Arguments: map[string]any{"content": "prompt", "project": "soqu-mem"}}})
	if err != nil {
	...
	sessionSummaryRes, err := handleSessionSummary(s)(context.Background(), mcppkg.CallToolRequest{Params: mcppkg.CallToolParams{Arguments: map[string]any{"project": "soqu-mem", "content": "summary"}}})
	if err != nil {
	...
	sessionStartRes, err := handleSessionStart(s)(context.Background(), mcppkg.CallToolRequest{Params: mcppkg.CallToolParams{Arguments: map[string]any{"id": "s1", "project": "soqu-mem"}}})
	if err != nil {
...
func TestMCPAdditionalCoverageBranches(t *testing.T) {
	...
	if err := s.CreateSession("s-extra", "soqu-mem", "/tmp/soqu-mem"); err != nil {
		t.Fatalf("create session: %v", err)
	}
	firstID, err := s.AddObservation(store.AddObservationParams{SessionID: "s-extra", Type: "note", Title: "first", Content: "first content", Project: "soqu-mem"})
	if err != nil {
		t.Fatalf("add first: %v", err)
	}
	_, err = s.AddObservation(store.AddObservationParams{SessionID: "s-extra", Type: "note", Title: "second", Content: "second content", Project: "soqu-mem"})
	if err != nil {
...
func TestHandleUpdateAcceptsAllOptionalFields(t *testing.T) {
	s := newMCPTestStore(t)
	if err := s.CreateSession("s-all-fields", "soqu-mem", "/tmp/soqu-mem"); err != nil {
		t.Fatalf("create session: %v", err)
	}
...
func TestHandleContextWithSessionOnlyUsesNoneProjects(t *testing.T) {
	s := newMCPTestStore(t)
	if err := s.CreateSession("s-context-none", "soqu-mem", "/tmp/soqu-mem"); err != nil {
		t.Fatalf("create session: %v", err)
	}
...
func TestHandleTimelineBeforeSectionAndSummaryBranches(t *testing.T) {
	s := newMCPTestStore(t)
	if err := s.CreateSession("s-timeline", "soqu-mem", "/tmp/soqu-mem"); err != nil {
		t.Fatalf("create session: %v", err)
	}
	_, err := s.AddObservation(store.AddObservationParams{SessionID: "s-timeline", Type: "note", Title: "first", Content: "first", Project: "soqu-mem"})
	if err != nil {
		t.Fatalf("add first observation: %v", err)
	}
	focusID, err := s.AddObservation(store.AddObservationParams{SessionID: "s-timeline", Type: "note", Title: "second", Content: "second", Project: "soqu-mem"})
	if err != nil {
		t.Fatalf("add second observation: %v", err)
	}
	_, err = s.AddObservation(store.AddObservationParams{SessionID: "s-timeline", Type: "note", Title: "third", Content: "third", Project: "soqu-mem"})
	if err != nil {
...
func TestHandleGetObservationIncludesTopicAndToolMetadata(t *testing.T) {
	s := newMCPTestStore(t)
	if err := s.CreateSession("s-get-meta", "soqu-mem", "/tmp/soqu-mem"); err != nil {
		t.Fatalf("create session: %v", err)
	}
	id, err := s.AddObservation(store.AddObservationParams{
...
func TestDefaultSessionIDScopedByProject(t *testing.T) {
	...
	if got := defaultSessionID("soqu-mem"); got != "manual-save-soqu-mem" {
		t.Fatalf("expected manual-save-soqu-mem, got %q", got)
	}
