// Package tui implements the Bubbletea terminal UI for soqu-mem.
//
// Following the Bubbletea patterns used across SOQU tooling:
...
import (
	...
	"github.com/soqudev/soqu-mem/internal/version"
