// Package version checks for newer soqu-mem releases on GitHub.
package version
...
func updateInstructions() string {
	switch runtime.GOOS {
	case "darwin":
		return "  brew update && brew upgrade soqu-mem"
	case "linux":
		return "  brew update && brew upgrade soqu-mem\n  or: go install github.com/soqudev/soqu-mem/cmd/soqu-mem@latest"
	default:
		return "  go install github.com/soqudev/soqu-mem/cmd/soqu-mem@latest\n  or: https://github.com/soqudev/soqu-mem/releases/latest"
	}
}
