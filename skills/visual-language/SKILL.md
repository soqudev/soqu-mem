---
name: soqu-mem-visual-language
description: >
  Visual language rules for soqu-mem surfaces. Trigger: Any dashboard styling,
...
1. The dashboard must feel like soqu-mem, not a generic SaaS admin.
